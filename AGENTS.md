# OpenSpain — Instrucciones para asistentes IA

Este archivo es el equivalente de [CLAUDE.md](CLAUDE.md) para otros asistentes (OpenAI Codex y similares). El contenido se mantiene sincronizado manualmente; cuando aparezca una convención común, ambos archivos se actualizan.

> **Para Claude**: ignora este archivo y usa [CLAUDE.md](CLAUDE.md) directamente. Es idéntico en contenido.
...
- `CLAUDE.md`: archivo análogo para Claude. Mantenerlo en sincronía manual; en algún momento converger.
