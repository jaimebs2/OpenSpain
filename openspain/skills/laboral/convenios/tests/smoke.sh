#!/usr/bin/env bash
# Smoke test para laboral-convenios
# Verifica que las páginas informativas del REGCON y BOE
...
echo "=== laboral-convenios smoke test ==="
echo ""

check_url "REGCON — buscador público" \
  "https://expinterweb.mites.gob.es/regcon/pub/consultaPublicaCondec"

check_url "Códigos de convenios colectivos (BOE)" \
  "https://www.boe.es/legislacion/codigos/codigo.php?id=236"
