#!/usr/bin/env bash
# Smoke test para fiscalidad-impuestos-locales
...
echo "=== fiscalidad-impuestos-locales smoke test ==="
echo ""

check_url "BOE — Ley de Haciendas Locales (RDLeg 2/2004)" \
  "https://www.boe.es/buscar/act.php?id=BOE-A-2004-4214"

check_url "Sede Catastro" \
