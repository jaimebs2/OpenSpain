#!/usr/bin/env bash
# Smoke test para fiscalidad-sucesiones-donaciones
# Verifica que las paginas informativas referenciadas en la skill
...
echo "=== fiscalidad-sucesiones-donaciones smoke test ==="
echo ""

check_url "Sede AEAT — Sucesiones y Donaciones" \
  "https://sede.agenciatributaria.gob.es/Sede/no-residentes/impuesto-sobre-sucesiones-donaciones/gestiones-sucesiones-donaciones.html"
