#!/usr/bin/env bash
# Smoke test para oposiciones
# Verifica que las páginas informativas de administracion.gob.es y BOE
...
echo "=== oposiciones smoke test ==="
echo ""

check_url "Portal de empleo público" \
  "https://administracion.gob.es/pag_Home/empleo-publico.html"

check_url "Punto de Acceso General" \
