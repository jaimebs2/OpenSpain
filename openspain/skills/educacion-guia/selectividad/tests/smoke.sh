...
echo "=== selectividad smoke test ==="
echo ""

check_url "Portal del Ministerio de Educación" \
  "https://www.educacionfpydeportes.gob.es"

check_url "Buscador de notas de corte" \
  "https://www.universidades.gob.es/que-estudiar-y-donde-qedu/"
