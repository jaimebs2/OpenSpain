#!/usr/bin/env bash
# Smoke test para becas-mec
# Verifica que las páginas informativas del Ministerio de Educación
...
echo "=== becas-mec smoke test ==="
echo ""

check_url "Portal de becas del MEC" \
  "https://www.educacionfpydeportes.gob.es/servicios-al-ciudadano/catalogo/estudiantes/becas-ayudas.html"

check_url "Sede electrónica del MEC" \
