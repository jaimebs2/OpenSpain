#!/usr/bin/env bash
# Smoke test para fp
# Verifica que las páginas informativas de TodoFP y el Ministerio de Educación
...
check_url "TodoFP — portal principal" \
  "https://www.todofp.es"

check_url "TodoFP — qué estudiar" \
  "https://www.todofp.es/que-estudiar.html"
