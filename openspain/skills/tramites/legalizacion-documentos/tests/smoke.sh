#!/usr/bin/env bash
# Smoke test para legalizacion-documentos
# Verifica que las páginas del MAEC y otros organismos referenciadas
...
echo "=== legalizacion-documentos smoke test ==="
echo ""
...
check_url "Convenio de La Haya — tabla de estados" \
