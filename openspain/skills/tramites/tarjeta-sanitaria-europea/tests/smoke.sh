#!/usr/bin/env bash
# Smoke test para tarjeta-sanitaria-europea
# Verifica que las páginas de la Seguridad Social referenciadas en la
...
echo "=== tarjeta-sanitaria-europea smoke test ==="
echo ""

check_url "Sede electrónica Seguridad Social" \
