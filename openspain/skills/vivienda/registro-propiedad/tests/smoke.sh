#!/usr/bin/env bash
# Smoke test para vivienda-registro-propiedad
# Verifica que las páginas del Colegio de Registradores
...
echo "=== vivienda-registro-propiedad smoke test ==="
echo ""

check_url "Colegio de Registradores" \
  "https://www.registradores.org"

check_url "Sede Electrónica Registradores" \
