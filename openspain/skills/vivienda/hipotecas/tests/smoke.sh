#!/usr/bin/env bash
# Smoke test para vivienda-hipotecas
# Verifica que las páginas informativas del Banco de España
...
echo "=== vivienda-hipotecas smoke test ==="
echo ""

check_url "Banco de España — Folletos informativos" \
  "https://www.bde.es/bde/es/secciones/informes/Folletos/"

check_url "Banco de España — Simulador de préstamos" \
