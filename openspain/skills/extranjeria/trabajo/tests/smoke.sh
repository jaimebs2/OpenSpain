#!/usr/bin/env bash
# Smoke test para extranjeria-trabajo
...
echo "=== extranjeria-trabajo smoke test ==="
echo ""

check_url "Portal de Inmigración — Inclusión" \
  "https://extranjeros.inclusion.gob.es"

check_url "SEPE — Profesiones de difícil cobertura" \
  "https://www.sepe.es/HomeSepe/empresas/informacion-para-empresas/profesiones-de-dificil-cobertura.html"

check_url "SEPE — Portal principal" \
  "https://www.sepe.es"
