#!/usr/bin/env bash
# Smoke test para proteccion-datos
# Verifica que las páginas informativas de la AEPD
...
echo "=== proteccion-datos smoke test ==="
echo ""

check_url "AEPD — Página principal" \
  "https://www.aepd.es"

check_url "AEPD — Canal prioritario" \
  "https://www.aepd.es/canalprioritario"

check_url "AEPD — Facilita RGPD" \
