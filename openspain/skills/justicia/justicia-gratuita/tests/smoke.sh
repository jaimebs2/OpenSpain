#!/usr/bin/env bash
# Smoke test para justicia-gratuita
# Verifica que las páginas informativas del Ministerio de Justicia
...
echo "=== justicia-gratuita smoke test ==="
echo ""

check_url "Ministerio de Justicia — Justicia gratuita" \
  "https://www.mjusticia.gob.es/es/ciudadania/tramites/asistencia-juridica-gratuita"
