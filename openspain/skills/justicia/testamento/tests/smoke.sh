#!/usr/bin/env bash
# Smoke test para testamento
# Verifica que las páginas informativas del Consejo General del Notariado
# y del Ministerio de Justicia referenciadas en la skill responden correctamente.
...
echo "=== testamento smoke test ==="
echo ""

check_url "Consejo General del Notariado" \
  "https://www.notariado.org"

check_url "Sede electrónica Ministerio de Justicia" \
