#!/usr/bin/env bash
# Smoke test para autofirma
# Verifica que las páginas informativas de AutoFirma y servicios de
# firma electrónica referenciados en la skill responden correctamente.
...
echo "=== autofirma smoke test ==="
echo ""

check_url "Descarga de AutoFirma" \
  "https://firmaelectronica.gob.es/Home/Descargas.html"

check_url "VALIDe — validación de firmas" \
  "https://valide.redsara.es"

check_url "Documentación técnica @firma" \
