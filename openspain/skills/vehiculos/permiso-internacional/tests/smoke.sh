#!/usr/bin/env bash
# Smoke test para permiso-internacional
...
echo "=== permiso-internacional smoke test ==="
echo ""

check_url "Sede DGT — Permiso internacional" \
  "https://sede.dgt.gob.es/es/permisos-de-conducir/permiso-internacional/"

check_url "Sede DGT — Cita previa" \
  "https://sede.dgt.gob.es/es/cita-previa/"
